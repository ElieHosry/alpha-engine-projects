...
#include <assert.h>
  ...
  #include "AEWinShim.h"      // minimal Win32 type/const shim for the web build
#else
  #include <windows.h>
#endif
...
// Fatal-error popup: a real MessageBox natively, a no-op on the web (no GUI dialogs).
#if defined(__EMSCRIPTEN__)
  #define AE_FATAL_BOX() ((void)0)
#else
  #define AE_FATAL_BOX() MessageBox(NULL, "Program Must Exit!", "Program Error", MB_OK)
#endif
