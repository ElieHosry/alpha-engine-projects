@echo off
REM ===========================================================================
REM  Build the Platformer web target (Emscripten) on Windows.
REM
REM  Prerequisites (see WEB_BUILD_SETUP.md):
...
if errorlevel 1 (
    ...
    echo See WEB_BUILD_SETUP.md for the full setup.
    exit /b 1
)
...
if "%DO_RUN%"=="1" (
    ...
    call emrun "%BUILD_DIR%\Platformer.html"
) else (
